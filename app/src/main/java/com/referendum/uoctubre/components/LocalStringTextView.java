...
public class LocalStringTextView extends AppCompatTextView {

    public LocalStringTextView(Context context) {
        super(context);
        init(null, context);
    }

    public LocalStringTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, context);
    }

    public LocalStringTextView(Context context, AttributeSet attrs, int defStyleAttr) {
